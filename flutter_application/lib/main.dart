            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => SchemeNavigatorScreen(),
                  ),
                );
              },
...
class DiseaseDiagnosisScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Text('Upload image to detect crop disease.')),
    );
  }
}
...
class MarketPricesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Text('View real-time mandi prices for your crops.')),
    );
  }
}
...
class SchemeNavigatorScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Text('Explore agriculture schemes in Kannada.')),
    );
  }
}
